...
For examples of how to use the module, run the jupyter notebook /visualizations/examples.pynb amd read the [Wiki](https://github.com/mathildebadoual/hmip/wiki).
